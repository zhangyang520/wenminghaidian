 ...
 * 轮播图Holder定义
 */
public class MainPagerHolder extends BaseHolder<HDC_CiviState> {
    ...
    public View initView() {
        ...
        rlPager.getLayoutParams().height = ScreenUtil.getInstance().getHeight(UiUtils.getInstance().getContext(),1120,736);
        ...
        System.out.println("MainPagerHolder initView start");
...
//                    mainViewPager.setCurrentItem(position);
    ...
    //进行轮播启动
    public void start() {
        synchronized (MainPagerHolder.class){
    ...
    @Override
    public void refreshView(HDC_CiviState hdc_carousel) {

    }

    @Override
    public void setDatas(List<HDC_CiviState> hdc_carousels) {
...
//                mainViewPager.setTotalSize(getDatas().size());
    ...
    class MainViewPagerAdapter extends PagerAdapter {
        ...
        private HDC_CiviState currentData;
        @Override
        public int getCount() {
        ...
        public Object instantiateItem(ViewGroup container,  int position) {
            ...
            currentPosition=((position)%getDatas().size());
            currentData=getDatas().get(currentPosition);
            ...
            imageView.setOnClickListener(new MyViewOnClickListener(currentPosition){
                ...
                public void onClick(View v) {
                        Intent intent=new Intent(activity, CiviStateDetailActivity.class);
                        intent.putExtra(CiviStateDetailActivity.ITEM_ID_AND_TYPE, getDatas().get(this.position).getItemId());
                        intent.putExtra(CiviStateDetailActivity.IS_FROM_LUNBO, true);
                        activity.startActivity(intent);
                }
            });
//            System.out.println("getDatas().size()=" + getDatas().size());
