 ...
 * 通知公告列表实体类
 */
public class HDC_Notice extends EntityBase {
    ...
    public HDC_Notice(String itemId, String title, int tipCount, String publishTime, int dianZanCount, String des, ImgEntity imgEntity, String itemType) {
        this.itemId = itemId;
        this.title = title;
